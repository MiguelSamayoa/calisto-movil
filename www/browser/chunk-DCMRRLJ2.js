...
var r = (t3) => {
  ...
  const M2 = t3, W2 = [], I = [], K = [], P3 = [], Z = [], x2 = [], B2 = [], J = [], q = [], z2 = [], G = [], H = "function" == typeof AnimationEffect || void 0 !== d && "function" == typeof d.AnimationEffect, L2 = "function" == typeof Element && "function" == typeof Element.prototype.animate && H, N = () => G, O = (e, o) => {
    ...
    0 !== S && (S--, 0 === S && ((() => {
      ...
      P3.forEach((e2) => {
        ...
        for (const o2 in n3)
          n3.hasOwnProperty(o2) && i(e2, o2, n3[o2]);
    ...
    (() => {
      ...
      P3.forEach((n3) => {
        ...
        for (const e2 in t4)
          t4.hasOwnProperty(e2) && i(n3, e2, t4[e2]);
      });
  ...
  return p2 = { parentAnimation: c2, elements: P3, childAnimations: Z, id: M2, animationFinish: te, from: le, to: (e, o) => {
    ...
    if (null != e)
      if (Array.isArray(e))
        for (const o of e)
          o.parent(p2), Z.push(o);
      else
        e.parent(p2), Z.push(e);
    return p2;
  }, addElement: (o) => {
    if (null != o)
      if (1 === o.nodeType)
        ...
        f("createAnimation - Invalid addElement value.");
    return p2;
...
var h2 = (n3) => __async(void 0, null, function* () {
  if (n3.leavingEl && n3.animated && 0 !== n3.duration)
    return n3.animationBuilder ? n3.animationBuilder : "ios" === n3.mode ? (yield import("./chunk-VBOLGZS4.js")).iosTransitionAnimation : (yield import("./chunk-D46JIKFG.js")).mdTransitionAnimation;
});
...
var B = (n3) => __async(void 0, null, function* () {
  ...
  if (e) {
    if (null != e.componentOnReady) {
      if (null != (yield e.componentOnReady()))
        return;
...
var x = (n3) => {
  if (n3.classList.contains("ion-page"))
    return n3;
...
@ionic/core/components/p-9VcRUwdB.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-DCMRRLJ2.js.map
