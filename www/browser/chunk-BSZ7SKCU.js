...
var o2 = (o3) => {
  ...
  const d = o3.getBoolean("animated", true) && o3.getBoolean("rippleEffect", true), v = /* @__PURE__ */ new WeakMap(), m = () => {
    ...
    if (l = Date.now(), t.classList.add(a), !d)
      return;
    const i2 = r(t);
...
var i = (t) => {
  if (void 0 === t.composedPath)
    return t.target.closest(".ion-activatable");
  {
    const e = t.composedPath();
    for (let t2 = 0; t2 < e.length - 2; t2++) {
      const o3 = e[t2];
      if (!(o3 instanceof ShadowRoot) && o3.classList.contains("ion-activatable"))
        return o3;
    }
  }
};
...
@ionic/core/components/p-BgwEQWW6.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-BSZ7SKCU.js.map
