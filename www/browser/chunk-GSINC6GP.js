...
var x = (o2, n, r, a, e2, d3, c2 = false, l2 = 0, u3 = true) => __async(void 0, null, function* () {
  ...
  if (r && Math.abs(w2.scrollAmount) < 4)
    return v(n), void (d3 && null !== r && (y(r, h), S(n, r, () => h = 0)));
  if (f2(o2, n, true, w2.inputSafeY, c2), v(n), d2(() => o2.click()), d3 && r && (h = w2.scrollPadding, y(r, h)), "undefined" != typeof window) {
    ...
    if (r) {
      const o3 = yield i(r);
      if (u3 && w2.scrollAmount > o3.scrollHeight - o3.clientHeight - o3.scrollTop)
        return "password" === n.type ? (w2.scrollAmount += 50, window.addEventListener("ionKeyboardDidShow", s)) : window.addEventListener("ionKeyboardDidShow", e3), void (a2 = setTimeout(e3, 1e3));
    }
    e3();
  }
});
...
@ionic/core/components/p-Cwv-vmkN.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-GSINC6GP.js.map
