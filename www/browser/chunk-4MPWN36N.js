...
var Filesystem = registerPlugin("Filesystem", {
  web: () => import("./chunk-4ELVC4KA.js").then((m) => new m.FilesystemWeb())
});

// src/app/core/services/photo.service.ts
var PhotoService = class _PhotoService {
  constructor() {
    this.BASE_DIR = Directory.Data;
    this.PHOTO_DIR = "calisto_photos";
  }
  // ─── Captura de foto ──────────────────────────────────────────────────────
  /**
    ...
    return __async(this, null, function* () {
      try {
        const photo = yield Camera2.getPhoto({
          ...
          // pregunta al usuario: cámara o galería
          promptLabelHeader: "Foto",
          promptLabelPhoto: "Elegir de galer\xEDa",
        ...
        if (!photo.base64String)
          return null;
        return yield this.savePhoto(photo, entityType, entityId ?? Date.now());
      } catch (error) {
  ...
  savePhoto(photo, entityType, entityId) {
    return __async(this, null, function* () {
  ...
  replacePhoto(oldPath, entityType, entityId) {
    return __async(this, null, function* () {
      const newPath = yield this.takePhoto(entityType, entityId);
      if (newPath) {
        yield this.deletePhoto(oldPath);
      }
      return newPath;
    });
  }
  ...
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _PhotoService, factory: _PhotoService.\u0275fac, providedIn: "root" });
  }
};
...
//# sourceMappingURL=chunk-4MPWN36N.js.map
