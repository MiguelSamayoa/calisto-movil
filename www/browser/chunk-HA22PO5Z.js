...
var u = (t3, ...e2) => {
  ...
  if ([c.WARN].includes(o2))
    return console.warn(`[Ionic Warning]: ${t3}`, ...e2);
};
var f = (t3, ...e2) => {
  const o2 = n.get("logLevel", c.ERROR);
  if ([c.ERROR, c.WARN].includes(o2))
    return console.error(`[Ionic Error]: ${t3}`, ...e2);
};
...
var y = (t3) => {
  if (t3.__stencil__getHostRef)
    return t3.__stencil__getHostRef();
};
...
function Z(t3, n2, e2) {
  let o2, s2 = 0, l2 = [];
  for (; s2 < t3.length; s2++) {
    if (o2 = t3[s2], o2["s-sr"] && (!n2 || o2["s-hn"] === n2) && (void 0 === e2 || X(o2) === e2) && (l2.push(o2), void 0 !== e2))
      return l2;
...
function tt(t3) {
  if (t3.assignedElements || t3.assignedNodes || !t3["s-sr"])
    return;
...
function et(t3, n2) {
  var e2;
  if (!(n2 = n2 || (null == (e2 = t3["s-ol"]) ? void 0 : e2.parentElement)))
...
var ot = (t3) => {
  ...
  t3.cloneNode = function(t4) {
    ...
    if (!e2 && t4) {
      ...
      for (; e3 < l2.length; e3++)
        t5 = l2[e3]["s-nr"], n3 = s2.every((t6) => !l2[e3][t6]), t5 && (o2.__appendChild ? o2.__appendChild(t5.cloneNode(true)) : o2.appendChild(t5.cloneNode(true))), n3 && o2.appendChild(l2[e3].cloneNode(true));
    }
    return o2;
  };
};
...
var ct = (t3) => {
  if (t3.__insertAdjacentHTML)
    return;
  const n2 = t3.insertAdjacentHTML;
  t3.insertAdjacentHTML = function(t4, e2) {
    if ("afterbegin" !== t4 && "beforeend" !== t4)
      return n2.call(this, t4, e2);
    const o2 = this.ownerDocument.createElement("_");
    let s2;
    if (o2.innerHTML = e2, "afterbegin" === t4)
      for (; s2 = o2.firstChild; )
        this.prepend(s2);
    else if ("beforeend" === t4)
      for (; s2 = o2.firstChild; )
        this.append(s2);
  };
};
    ...
    if (o2) {
      ...
      if (s2.forEach((s3) => {
        if (s3 !== n2 && null !== n2)
          ...
          if (l3 = true, null === n2 || e2 !== n2["s-sn"])
            return void this.appendChild(t4);
          if (e2 === n2["s-sn"]) {
            Q(t4, o2);
...
var St = (t3, n2, e2) => {
  ...
  if (!k.document)
    return i2;
  if (t3 = 11 === t3.nodeType ? t3 : k.document, r2)
    if ("string" == typeof r2) {
      ...
      if (c2)
        ...
        if (null != c3 && e3.setAttribute("nonce", c3), !(1 & n2.i))
          if ("HEAD" === t3.nodeName) {
      ...
      if (n3 || Ot.set(t3, n3 = /* @__PURE__ */ new Set()), !n3.has(i2)) {
        ...
        let o3;
        if (r2.constructor === e3.CSSStyleSheet)
          o3 = r2;
        else {
          o3 = new e3.CSSStyleSheet();
          for (let t4 = 0; t4 < r2.cssRules.length; t4++)
            o3.insertRule(r2.cssRules[t4].cssText, t4);
        }
...
var Ct = (t3, n2, ...e2) => {
  ...
  const c2 = [], u2 = (n3) => {
    for (let e3 = 0; e3 < n3.length; e3++)
      o2 = n3[e3], Array.isArray(o2) ? u2(o2) : null != o2 && "boolean" != typeof o2 && ((i2 = "function" != typeof t3 && !Et(o2)) && (o2 = String(o2)), i2 && r2 ? c2[c2.length - 1].p += o2 : c2.push(i2 ? kt(null, o2) : o2), r2 = i2);
  };
  if (u2(e2), n2) {
...
var _t = (t3, n2) => {
  if (1 === t3.nodeType) {
    ...
    let o2 = 0;
    if (t3.shadowRoot)
      for (; o2 < t3.shadowRoot.childNodes.length; o2++)
        _t(t3.shadowRoot.childNodes[o2], n2);
...
var Vt = (t3, n2, e2, o2, s2) => {
  ...
  if (t3[n2] = t3[n2] || [], r2 && !(null == (l2 = r2.nodeValue) ? void 0 : l2.startsWith("s.")))
    do {
...
var zt = class t2 {
  static fromLocalValue(n2) {
    ...
    switch (e2) {
      ...
      case "object":
        const s2 = {};
        for (const [n4, e3] of o2)
          s2[n4] = t2.fromLocalValue(e3);
        return s2;
      case "regexp":
...
var Zt = (t3, n2, e2, o2, s2, l2, i2) => {
  ...
  if ("class" === n2) {
    ...
    if ((t3["s-si"] || t3["s-sc"]) && i2) {
      ...
      n3.remove(...s3.filter((t4) => t4 && !l3.includes(t4))), n3.add(...l3.filter((t4) => t4 && !s3.includes(t4)));
  } else if ("style" === n2) {
    for (const n3 in e2)
      o2 && null != o2[n3] || (n3.includes("-") ? t3.style.removeProperty(n3) : t3.style[n3] = "");
    for (const n3 in o2)
      e2 && o2[n3] === e2[n3] || (n3.includes("-") ? t3.style.setProperty(n3, o2[n3]) : t3.style[n3] = o2[n3]);
  } else if ("key" === n2)
    ;
  else if ("ref" === n2)
    o2 && yn(o2, t3);
...
var tn = (t3, n2, e2, o2) => {
  ...
  for (const t4 of nn(Object.keys(l2)))
    t4 in i2 || Zt(s2, t4, l2[t4], void 0, e2, n2.i, o2);
  for (const t4 of nn(Object.keys(i2)))
    Zt(s2, t4, l2[t4], i2[t4], e2, n2.i, o2);
};
function nn(t3) {
...
var un = (t3, n2, e2) => {
  ...
  const s2 = n2.j[e2];
  let l2, i2, r2, c2 = 0;
  if (en || (sn = true, "slot" === s2.S && (s2.i |= s2.j ? 2 : 1)), null != s2.p)
    l2 = s2.C = k.document.createTextNode(s2.p);
  else if (1 & s2.i)
    l2 = s2.C = k.document.createTextNode(""), tn(null, s2, ln);
  else {
    if (ln || (ln = "svg" === s2.S), !k.document)
    ...
    if (l2 = s2.C = k.document.createElementNS(ln ? "http://www.w3.org/2000/svg" : "http://www.w3.org/1999/xhtml", !en && 2 & s2.i ? "slot-fb" : s2.S), ln && "foreignObject" === s2.S && (ln = false), tn(null, s2, ln), null != (u2 = Tt) && void 0 !== u2 && l2["s-si"] !== Tt && l2.classList.add(l2["s-si"] = Tt), s2.j) {
      ...
      for (c2 = 0; c2 < s2.j.length; ++c2)
        i2 = un(t3, s2, c2), i2 && n3.appendChild(i2);
    }
...
var fn = (t3) => {
  ...
  if (null != n2) {
    ...
    for (const t4 of e2 ? o2.reverse() : o2)
      null != t4["s-sh"] && (wn(n2, t4, null != e2 ? e2 : null), t4["s-sh"] = void 0, sn = true);
  }
  M.i &= -2;
};
var an = (t3, n2) => {
  ...
  if (t3["s-sr"]) {
    ...
    for (; n3 = n3.nextSibling; )
      n3 && n3["s-sn"] === t3["s-sn"] && n3["s-sh"] === Dt && e2.push(n3);
  }
...
var dn = (t3, n2, e2, o2, s2, l2) => {
  ...
  for (r2.shadowRoot && r2.tagName === Dt && (r2 = r2.shadowRoot), "template" === e2.S && (r2 = r2.content); s2 <= l2; ++s2)
    o2[s2] && (i2 = un(null, e2, s2), i2 && (o2[s2].C = i2, wn(r2, i2, pn(n2))));
};
var hn = (t3, n2, e2) => {
  ...
  null == r2 ? (ln = "svg" === i2 || "foreignObject" !== i2 && ln, "slot" !== i2 || en || t3.N !== n2.N && (n2.C["s-sn"] = n2.N || "", fn(n2.C.parentElement)), tn(t3, n2, ln, e2), null !== s2 && null !== l2 ? ((t4, n3, e3, o3, s3 = false) => {
    ...
    for (; r3 <= a2 && c3 <= v2; )
      if (null == d2)
        ...
        $n(d2, p2, s3), d2 = n3[++r3], p2 = o3[++c3];
      else if (vn(h2, $2, s3))
        $n(h2, $2, s3), h2 = n3[--a2], $2 = o3[--v2];
      else if (vn(d2, $2, s3))
        "slot" !== d2.S && "slot" !== $2.S || an(d2.C.parentNode, false), $n(d2, $2, s3), wn(b2, d2.C, h2.C.nextSibling), d2 = n3[++r3], $2 = o3[--v2];
      else if (vn(h2, p2, s3))
        "slot" !== d2.S && "slot" !== $2.S || an(h2.C.parentNode, false), $n(h2, p2, s3), wn(b2, h2.C, d2.C), h2 = n3[--a2], p2 = o3[++c3];
      else {
        for (u2 = -1, f2 = r3; f2 <= a2; ++f2)
          if (n3[f2] && null !== n3[f2].O && n3[f2].O === p2.O) {
            u2 = f2;
            break;
          }
  ...
  for (const t4 of s2) {
    if (t4["s-sr"] && (n2 = t4["s-cr"]) && n2.parentNode) {
      ...
      for (o2 = e2.length - 1; o2 >= 0; o2--)
        if (n2 = e2[o2], !(n2["s-cn"] || n2["s-nr"] || n2["s-hn"] === t4["s-hn"] || n2["s-sh"] && n2["s-sh"] === t4["s-hn"]))
          if (K(n2, s3)) {
            ...
            bn.some((t5) => t5.L === n2) || bn.push({ L: n2 });
    }
    1 === t4.nodeType && gn(t4);
  }
};
...
var wn = (t3, n2, e2, o2) => {
  if ("string" == typeof n2["s-sn"] && n2["s-sr"] && n2["s-cr"])
    jn(n2["s-cr"], n2, t3, n2.parentElement);
...
var On = (t3, n2, e2 = false) => {
  ...
  if (Dt = c2.tagName, u2.F && (d2.$ = d2.$ || {}, u2.F.forEach(([t4, n3]) => {
    ...
    for (const t4 of Object.keys(d2.$))
      c2.hasAttribute(t4) && !["key", "ref", "style", "class"].includes(t4) && (d2.$[t4] = c2[t4]);
  if (d2.S = null, d2.i |= 4, t3.B = d2, d2.C = f2.C = c2.shadowRoot || c2, Tt = c2["s-sc"], en = !(!(1 & u2.i) || 128 & u2.i), Ut = c2["s-cr"], on = false, $n(f2, d2, e2), M.i |= 1, sn) {
    ...
    for (const t4 of bn) {
      ...
      if (1 === n3.nodeType && e2 && (n3["s-ih"] = null != (o2 = n3.hidden) && o2), r3) {
        ...
        if (o3 && 1 === o3.nodeType) {
          ...
          for (; e3; ) {
            ...
            if (s3 && s3["s-sn"] === n3["s-sn"] && t5 === (s3.__parentNode || s3.parentNode)) {
              for (s3 = s3.nextSibling; s3 === n3 || (null == s3 ? void 0 : s3["s-sr"]); )
                s3 = null == s3 ? void 0 : s3.nextSibling;
              if (!s3 || !s3["s-nr"]) {
                o3 = s3;
                break;
              }
        ...
        1 === n3.nodeType && (n3.hidden = true);
    }
  }
  if (on && J(d2.C), M.i &= -2, bn.length = 0, !en && !(1 & u2.i) && c2["s-cr"]) {
    const t4 = d2.C.__childNodes || d2.C.childNodes;
    for (const n3 of t4)
      if (n3["s-hn"] !== Dt && !n3["s-sh"]) {
        if (e2 && null == n3["s-ih"] && (n3["s-ih"] = null != (r2 = n3.hidden) && r2), 1 === n3.nodeType)
          n3.hidden = true;
...
var xn = (t3, n2) => {
  ...
  if (!o2)
    throw new Error(`Can't render component <${e2.tagName.toLowerCase()} /> with invalid Stencil runtime! Make sure this imported component is compiled with a \`externalRuntime: true\` flag. For more information, please refer to https://stenciljs.com/docs/custom-elements#externalruntime`);
  let s2;
...
var Bn = (t3, n2, e2, o2) => {
  ...
  if (e2 !== i2 && !u2) {
    ...
    if (2 & r2) {
      if (c2.componentShouldUpdate && false === c2.componentShouldUpdate(e2, i2, n2) && !(16 & r2))
        return;
      16 & r2 || Sn(s2, false);
    }
  }
    ...
    l2.map(([t4, [e3]]) => {
      if (31 & e3 || 32 & e3) {
        ...
        o3 && (n2.t[t4][0] |= 2048), l3 && (n2.t[t4][0] |= 4096), Object.defineProperty(s2, t4, { get() {
          ...
          if (s3) {
            if (l3)
              return void 0 === (32 & e3 ? this[t4] : s3.$hostElement$[t4]) && s3.l.get(t4) && (o4 = s3.l.get(t4)), l3.apply(this, [Ht(o4, e3)]), void Bn(this, t4, o4 = 32 & e3 ? this[t4] : s3.$hostElement$[t4], n2);
            Bn(this, t4, o4, n2);
          }
        } });
      }
    });
    {
      ...
      s2.attributeChangedCallback = function(t4, o3, i2) {
        M.jmp(() => {
          ...
          if (this.hasOwnProperty(c2), s2.hasOwnProperty(c2) && "number" == typeof this[c2] && this[c2] == i2)
            return;
          if (null == c2) {
...
var Tn = (t3) => {
  if (!(1 & M.i)) {
    ...
    if (1 & n2.i)
      Wn(t3, n2, e2.Y), (null == n2 ? void 0 : n2.q) || (null == n2 ? void 0 : n2.Z) && n2.Z.then(() => {
      });
    else {
      let o3;
        ...
        ((t4, n3, e3, o4) => {
          ...
          for (; p2 < $2; p2++) {
            ...
            if (c2) {
              ...
              l3["s-hn"] = n3.toUpperCase(), "slot" === b2.S && (l3["s-cr"] = t4["s-cr"]);
          ...
          for (; x2 < m2; x2++)
            if (w2 = a2[x2], w2 && w2.length)
              for (O2 = w2.length, j2 = 0; j2 < O2; j2++) {
                if (N2 = w2[j2], g2[N2.hostId] || (g2[N2.hostId] = M.V.get(N2.hostId)), !g2[N2.hostId])
                  continue;
      ...
      {
        let e3 = t3;
        for (; e3 = e3.parentNode || e3.host; )
          if (1 === e3.nodeType && e3.hasAttribute("s-id") && e3["s-p"] || e3["s-p"]) {
            Nn(n2, n2.U = e3);
            break;
          }
      }
...
var Dn = (t3, n2) => {
  ...
  try {
    e2.t = n2[2], e2.Y = n2[3], e2.W = t3.W, e2.H = t3.H, e2.J = t3.J, e2.F = [], !(1 & e2.i) && 256 & e2.i ? (ot(o2 = t3.prototype), st(o2), rt(o2), it(o2), at(o2), ct(o2), ut(o2), ft(o2), dt(o2), ht(o2), lt(o2)) : ot(t3.prototype), (() => {
      ...
      let n3 = 0;
      for (; n3 < t4.length; n3++)
        Nt(t4[n3].getAttribute(x), t4[n3].innerHTML.replace(/\/\*!@([^\/]+)\*\/[^\{]+\{/g, "$1{"), true);
    })();
    ...
    return Object.assign(t3.prototype, { __hasHostListenerAttached: false, __registerHost() {
      ...
      if (this.shadowRoot) {
        if ("open" !== this.shadowRoot.mode)
          throw new Error(`Unable to re-use existing shadow root for ${e2.v}! Mode is set to ${this.shadowRoot.mode} but Stencil only supports open shadow roots.`);
      } else
        H.call(this, e2);
...
@ionic/core/components/p-BJoMtgfR.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-HA22PO5Z.js.map
